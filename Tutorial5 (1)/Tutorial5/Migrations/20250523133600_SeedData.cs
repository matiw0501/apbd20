    ...
    public partial class SeedData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "anna.k@clinic.com", "Anna", "Kowalska" },
                    { 2, "t.nowak@clinic.com", "Tomasz", "Nowak" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Painkiller", "Ibuprom", "Tablet" },
                    { 2, "Fever reducer", "Paracetamol", "Tablet" },
                    { 3, "Antibiotic", "Amoxicillin", "Capsule" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, new DateTime(1985, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "Maria", "Wiśniewska" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, new DateTime(2024, 1, 14, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 },
                    { 2, new DateTime(2024, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, new DateTime(2024, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 2 }
                });
