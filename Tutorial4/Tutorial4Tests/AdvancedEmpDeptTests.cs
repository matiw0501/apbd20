...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnDistinctJobTitles()
    {
        ...
        var jobs = emps.Distinct()
            .Select(e=> e.Job).ToList(); 
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps.
            Join(emps,
                empl => empl.Mgr, mgr=> mgr.EmpNo, (empl, mgr) => new { Employee = empl.EName, Manager = mgr.EName }) ;
    ...
    public void ShouldReturnTotalIncomeIncludingCommission()
    {
      ...
      var result = emps.Select(emps => new {EName = emps.EName, Total = emps.Sal + (emps.Comm != null ? emps.Comm : 0) })
          .ToList(); 
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = (from e in emps
            ...
            from g in grades
            where g.Grade <= e.Sal && e.Sal <= g.Hisal select new 
        {
           EName = e.EName, DName= d.DName, Grade= g.Grade             
        });
           ;
